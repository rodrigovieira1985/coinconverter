...
import com.example.coinconverter.core.extensions.hideSoftKeyboard
import com.example.coinconverter.core.extensions.text
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindListeners() {
        binding.tilValue.editText?.doAfterTextChanged {
            binding.btnConverter.isEnabled = it != null && it.toString().isNotEmpty() && it.toString() !="."
